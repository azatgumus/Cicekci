        ...
        <WizardSteps>
            <asp:CreateUserWizardStep ID="RegisterUserWizardStep" runat="server">
                <ContentTemplate>
                    ...
                    <p>
                        Şifre için minimum <%= Membership.MinRequiredPasswordLength %> karakter gereklidir.
                    </p>
                    ...
                    <div class="accountInfo">
                        ...
                        <p class="submitButton">
                            <asp:Button ID="CreateUserButton" runat="server" CommandName="MoveNext" Text="Kullanıcı oluştur" 
                                 ValidationGroup="RegisterUserValidationGroup"/>
                        </p>
                    </div>
                </ContentTemplate>
