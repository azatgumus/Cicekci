        ...
        <LayoutTemplate>
            ...
            <div class="accountInfo">
                ...
                <p style="padding: 20px;">
                 Eğer hesabınız yoksa şimdi kaydolun.  <br /><br />
                 <asp:ImageButton ID="RegisterHyperLink" runat="server" EnableViewState="false" 
                        ImageUrl="../Styles/Resimler/Kaydol.png" PostBackUrl="~/Account/Register.aspx" OnClick="RegisterHyperLink_Click"></asp:ImageButton>
                </p>
            </div>
        </LayoutTemplate>
    </asp:Login>
